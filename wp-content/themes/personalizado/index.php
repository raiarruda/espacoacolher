    ...
    <section id="inicial" class="tela-inteira">
        ...
        <div class="row">
            ...
            <div class="col col-md-8 col-sm-8">
                <div class="row">
                    <h3 class="text-center m-2 font-weight-bold"> standard Lorem Ipsum passage, used since the 1500s</h2>
                            ...
                            <div class="card card-profile card-plain">
                                ...
                                <div class="col">
                                    <div class="card-image">
                                        <img class="img-circle img-no-padding img-responsive" src="<?=the_post_thumbnail_url();?>">
                                ...
                                <div class="col">
                                    <div class="content">
                                        <h4 class="images-title"><?=the_title();?></h4>
                                        <h6 class="">CEO</h6>
            ...
            while ($the_query->have_posts()):
                $the_query->the_post();?>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <img class="imagem-convenio img-fluid" src="<?=the_post_thumbnail_url();?>" alt="<?=the_title();?>">
                            </div>
                            <div class="col">
